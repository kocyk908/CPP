...
/*   Updated: 2025/01/15 15:41:54 by lkoc             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::beRepaired(unsigned int amount)
{
	if (energy_points > 0 && hit_points > 0)
	{
		std::cout << name << " gains " << amount << " points of health" << std::endl;
		hit_points += amount;
		energy_points--;
	}
	else if (hit_points <= 0)
		...
		std::cout << name << " energy is too low to repair itself" << std::endl;
}
...
void ClapTrap::takeDamage(unsigned int amount)
{
	if (hit_points > 0)
	{
		std::cout << name << " takes " << amount << " hit points" << std::endl;
		hit_points -= amount;
		if (hit_points <= 0)
			std::cout << name << " has been killed" << std::endl;
	}
	else
		std::cout << name << " is dead and can't take more damage" << std::endl;
}